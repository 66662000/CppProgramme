...
int main()
{
    ...
    start:
          int a = 0;
    double value1; /*Declaration des variables*/
    double value2;
    double result;
    char oOperator;


    cout << "Notre realisation, Une calculatrice en c++.\n\nEntrer un nombre, un operateur puis un autre nombre! Ex: \n1+1, 1x1, 1/1, 1-1 (x + / -) \a \n";
    ...
    cout << "\n";
    cout << "Reesayez: 1 ou quitter: 2... entrer le No:";
    cin >> a;
    if (a==1)
    goto start;
    if (a==2)
